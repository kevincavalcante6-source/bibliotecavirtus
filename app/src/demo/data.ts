...
const wallpaperArt169 = (a: string, b: string, word: string) =>
  svgUrl(
    `<svg xmlns="http://www.w3.org/2000/svg" viewBox="0 0 1080 1920"><defs><radialGradient id="g" cx="50%" cy="10%" r="92%"><stop offset="0" stop-color="${a}"/><stop offset="55%" stop-color="${b}"/><stop offset="100%" stop-color="#060606"/></radialGradient></defs><rect width="1080" height="1920" fill="url(#g)"/><text x="540" y="960" fill="#F5F5F0" fill-opacity="0.92" font-family="Inter,sans-serif" font-size="74" font-weight="500" letter-spacing="26" text-anchor="middle">${word}</text><rect x="455" y="1092" width="170" height="2" fill="#806B42"/></svg>`,
  );
...
const SEEDS: Seed[] = [
  ...
  { title: "Fé", type: "wallpaper", art: wallpaperArt169("#1F1D24", "#09090A", "FÉ"), width: 1080, height: 1920, downloads: 0, age: 3 },
  ...
  { title: "Norte", type: "wallpaper", art: wallpaperArt169("#20201D", "#090909", "NORTE"), width: 1080, height: 1920, downloads: 0, age: 12 },
